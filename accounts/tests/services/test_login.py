...
class TestLoginWithPassword(BaseTestCase):
    """Test class for the loginWithPassword method following test guide principles."""
    ...
    def test_login_success(self):
        ...
        response = self.auth_service.loginWithPassword(
            username=self.user.user.username, password="password123"
        )
    ...
    def test_login_invalid_credentials(self):
        ...
        response = self.auth_service.loginWithPassword(
            username=self.user.user.username, password="wrongpassword"
        )
